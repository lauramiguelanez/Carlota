...
export default class ProjectsStrip extends Component {
  ...
  getAboutCategory() {
    if (this.state.category === 'TRANSLATION') {
      ...
      return (
        <div className="category-about">
          <p>My research practice sits at the intersection between academia and more experimental, artistic formats. Working both individually and collectively, my work gravitates around notions such as domesticity, the (counter)archive of art history, or heritage and queer/feminist issues in contemporary art, visual cultures and architecture.</p>
          <p>I currently carry out Post MA research in Architectural Theory and History at the <a href="https://www.kkh.se/en/">Royal Institute of Art, Stockholm</a>.</p>
          <p>My individual work has featured in various academic and independent platforms, such as <a href="http://etsamadrid.aq.upm.es/">Madrid School of Architecture</a>, <a href="http://www.weareorlando.co.uk/">Orlando Magazine</a>, <a href="https://www.ugr.es/">Universidad de Granada</a>, or <a href="http://uam.es/UAM/Home.htm?language=es">Universidad Autónoma de Madrid</a>, amongst others. Collective work as part of the curatorial team of the architectural platform <a href="https://doscincocincodaetsam.wordpress.com/">255</a> has been exhibited at the <a href="https://www.labiennale.org/en/architecture/2018/national-participations/spain">Spanish Pavilion of the 2018 Venice Architecture Biennale</a>. Collective projects the context of the Royal Institute of Art in Stockholm have featured in <a href="http://m12.manifesta.org/">Manifesta ’12</a>, <a href="http://aschoolofschools.iksv.org/">Istanbul Design Biennial</a>, or <a href="http://www.konsthallc.se/">Konsthall C</a> in Stockholm.</p>
          <p>I graduated from her BA in Art History and French with Study Abroad Year in 2013 (<a href="https://www.sussex.ac.uk/">University of Sussex, Great Britain</a>/<a href="http://english.lettres.sorbonne-universite.fr/">Paris Sorbonne IV, France</a>) and I hold an MA in Contemporary Art and Visual Culture (Distinction) from <a href="http://uam.es/UAM/Home.htm?language=es">Universidad Autónoma de Madrid</a>/<a href="https://www.museoreinasofia.es/">Museo Nacional Reina Sofia</a>.</p>
        </div>
      )
    }else {
      return <div />;
